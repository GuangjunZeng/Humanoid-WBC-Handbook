...
def command_projects_status(args: argparse.Namespace) -> int:
    try:
        ...
        report = project_coverage_report(project_catalog, paper_catalog.get("domains", {}))
        report["ok"] = not errors
        report["errors"] = errors
    except (OSError, ValueError, json.JSONDecodeError) as exc:
...
def build_parser() -> argparse.ArgumentParser:
    ...
    project_status.add_argument("--catalog", default="content/papers/project-catalog.json")
    project_status.add_argument("--paper-catalog", default="content/papers/catalog.json")
    ...
    project_discover.add_argument("--catalog", default="content/papers/project-catalog.json")
    project_discover.add_argument("--paper-catalog", default="content/papers/catalog.json")
    project_discover.add_argument("--root", default=".")
    project_discover.add_argument("--out", default="var/paper-update/project-candidates.json")
