...
| 深度解读 | [Learning Human-to-Humanoid Real-Time Whole-Body Teleoperation](../h2o-2403.04436v1.md) | 2024 | 领域锚点（field anchor）、开源实现（open source） | [官方代码](https://github.com/LeCAR-Lab/human2humanoid) | 早期真实全尺寸人形学习式实时全身遥操锚点，建立 sim-to-data 筛选管线。 |
