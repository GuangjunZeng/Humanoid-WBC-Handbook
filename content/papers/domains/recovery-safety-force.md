...
- 当前收录：16 篇，其中深度解读 7 篇，有可核验官方代码 11 篇。
...
| 深度解读 | [SafeFall: Learning Protective Control for Humanoid Robots](../safefall-2511.18509.md) | 2025 | 保护性跌倒（protective fall）、实机证据（hardware evidence） | 待核验 | 用跌倒预测器触发伤害缓解策略，显式保护头、手等脆弱部件。 |
