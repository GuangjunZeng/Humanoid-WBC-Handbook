...
- 当前收录：9 个项目，其中已审代码 7 个、无对应论文的独立项目 2 个。
...
| 已审代码 | [GVHMR](../projects/gvhmr.md) | 论文官方实现 | 1840 | Custom educational, research, and non-commercial license | 从移动相机视频恢复世界坐标人体运动，是机器人重定向前的数据入口代表。 |
