...
![Figure 5-7：状态—潜动作扩散与任务引导](assets/beyondmimic-2508.08241v4/figure-5-guidance.jpg)

Figure 5-7 要从引导信号读回控制链：去噪过程对未来状态和潜动作生成短视轨迹，任务代价的梯度在每次去噪中推动样本，最新本体观测再解码当前动作。这是短 horizon 重规划，不是一次性生成整段开环动作。
