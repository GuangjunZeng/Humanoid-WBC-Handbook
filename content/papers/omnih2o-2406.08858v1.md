...
![Figure 2-3：数据扩充与教师—学生系统链](assets/omnih2o-2406.08858v1/figure-2-system.jpg)

Figure 2-3 把“数据问题”和“控制问题”连在一起。固定下肢的站立/下蹲变体先补足操作场景的运动分布；特权教师再把这些全身动作变成物理可跟踪的行为；最后学生才从稀疏目标与历史中恢复这种行为。因而图中每个箭头都是一个可独立测试的误差边界。
